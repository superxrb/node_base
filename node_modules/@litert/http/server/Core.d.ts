...
export interface ServerResponse extends http.ServerResponse {
     ...
     * > NOTES: This must be called with setting up cookies for server.
     */
    setCookie(name: string, value: string, ttl?: number, httpOnly?: boolean, secureOnly?: boolean, path?: string, domain?: string): ServerResponse;
    /**
     * Set the cookies of response.
     *
     * > NOTES: This must be called with setting up cookies for server.
     */
    setCookie(cookie: SetCookieConfiguration): ServerResponse;
}
...
export interface StandardRouter extends Router {
     ...
     */
    use(method: HTTPMethod | HTTPMethod[], path: string | RegExp | Array<string | RegExp>, middleware: RequestMiddleware): StandardRouter;
    /**
     ...
     * @param middleware The middleware handler.
     */
    use(method: HTTPMethod | HTTPMethod[], middleware: RequestMiddleware): StandardRouter;
    /**
     ...
     * @param middleware The middleware handler.
     */
    use(path: string | RegExp | Array<string | RegExp>, middleware: RequestMiddleware): StandardRouter;
    /**
     ...
     * @throws Exception
     */
    register(method: HTTPMethod | HTTPMethod[], path: string | RegExp | Array<string | RegExp>, handler: RequestHandler, data?: IDictionary<any>): StandardRouter;
    /**
     ...
     * @throws Exception
     */
    get(path: string | RegExp | Array<string | RegExp>, handler: RequestHandler, data?: IDictionary<any>): StandardRouter;
    /**
     ...
     * @throws Exception
     */
    post(path: string | RegExp | Array<string | RegExp>, handler: RequestHandler, data?: IDictionary<any>): StandardRouter;
    /**
     ...
     * @throws Exception
     */
    put(path: string | RegExp | Array<string | RegExp>, handler: RequestHandler, data?: IDictionary<any>): StandardRouter;
    /**
     ...
     * @throws Exception
     */
    patch(path: string | RegExp | Array<string | RegExp>, handler: RequestHandler, data?: IDictionary<any>): StandardRouter;
    /**
     ...
     * @throws Exception
     */
    delete(path: string | RegExp | Array<string | RegExp>, handler: RequestHandler, data?: IDictionary<any>): StandardRouter;
    /**
     ...
     * @throws Exception
     */
    options(path: string | RegExp | Array<string | RegExp>, handler: RequestHandler, data?: IDictionary<any>): StandardRouter;
    /**
     ...
     * @throws Exception
     */
    head(path: string | RegExp | Array<string | RegExp>, handler: RequestHandler, data?: IDictionary<any>): StandardRouter;
    /**
     ...
     * @throws Exception
     */
    trace(path: string | RegExp | Array<string | RegExp>, handler: RequestHandler, data?: IDictionary<any>): StandardRouter;
}
